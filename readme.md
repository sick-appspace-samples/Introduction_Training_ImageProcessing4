## Introduction_Training_ImageProcessing4
Additional processing via appended decoders
...
The purpose of this one is to show the further found position(s) and each
decoded content of the periodically provided data via overlays due to appended
decoders of other data code types.

### Topics
training, introduction, append, decode, image, processing, sampleapp, sick-appspace
